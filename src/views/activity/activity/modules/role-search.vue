      ...
      <NCollapseItem :title="$t('common.search')" name="role-search">
        <NForm :model="model" label-placement="left" :label-width="80">
          <NGrid responsive="screen" item-responsive>
            <NFormItemGi span="24 s:12 m:6" label="活动名称" path="realName" class="pr-24px">
              <NInput v-model:value="model.title" />
            </NFormItemGi>

            <NFormItemGi span="24 s:12 m:6" label="所属社团" path="realName" class="pr-24px">
...
-->
            <NFormItemGi span="24 s:12 m:6">
              <NSpace class="w-full" justify="end">
                ...
                <NButton v-if="hasAuth('BUTTON_SEARCH_ACTIVITY')" type="primary" ghost @click="search">
                  <template #icon>
