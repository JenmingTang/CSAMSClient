...
export const generatedRoutes: GeneratedRoute[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        name: 'activity_activity-location',
        path: '/activity/activity-location',
      ...
      {
        name: 'activity_activity-member',
        path: '/activity/activity-member',
  ...
  },
  {
    ...
    children: [
      ...
      {
        name: 'club_club-member',
        path: '/club/club-member',
    ...
    children: [
      {
        name: 'info_class',
        path: '/info/class',
        component: 'view.info_class',
        meta: {
          title: 'info_class',
          icon: 'ic:outline-class',
          roles: ['SUPER_ADMIN'],
          i18nKey: 'route.info_class'
        }
      },
      {
        name: 'info_department',
        path: '/info/department',
        component: 'view.info_department',
        meta: {
          title: 'info_department',
          roles: ['SUPER_ADMIN'],
          i18nKey: 'route.info_department'
        }
      },
      {
        name: 'info_major',
        path: '/info/major',
        component: 'view.info_major',
        meta: {
          title: 'info_major',
          roles: ['SUPER_ADMIN'],
          i18nKey: 'route.info_major'
        }
      },
      {
        name: 'info_person',
